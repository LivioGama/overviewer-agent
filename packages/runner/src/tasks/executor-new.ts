...
export class TaskExecutor {
  ...
  constructor(private ollama: OllamaService) {
    this.tasks = new Map()
    this.tasks.set('refactor', (ollama, octokit, workspace) => new RefactorTask(ollama, octokit, workspace))
    this.tasks.set('test_generation', (ollama, octokit, workspace) => new TestGenerationTask(ollama, octokit, workspace))
    this.tasks.set('documentation', (ollama, octokit, workspace) => new DocumentationTask(ollama, octokit, workspace))
    this.tasks.set('security_audit', (ollama, octokit, workspace) => new SecurityAuditTask(ollama, octokit, workspace))
    this.tasks.set('bug_fix', (ollama, octokit, workspace) => new BugFixTask(ollama, octokit, workspace))
    this.tasks.set('code_quality', (ollama, octokit, workspace) => new CodeQualityTask(ollama, octokit, workspace))
  }
