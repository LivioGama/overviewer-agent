    ...
    try {
      ...
      const redirectUrl =
        env.NODE_ENV === "development"
          ...
          : `https://overviewer-agent.liviogama.com/setup/success?installation_id=${installationId}`;
      ...
      const redirectUrl =
        env.NODE_ENV === "development"
          ...
          : `https://overviewer-agent.liviogama.com/setup/error`;
    ...
    try {
      ...
      const redirectUrl =
        env.NODE_ENV === "development"
          ...
          : `https://overviewer-agent.liviogama.com/auth/success?user=${userData.login}`;
      ...
      const redirectUrl =
        env.NODE_ENV === "development"
          ...
          : `https://overviewer-agent.liviogama.com/auth/error`;
