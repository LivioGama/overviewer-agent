...
export async function jobRoutes(fastify: FastifyInstance) {
  fastify.get('/installations/:installationId/jobs', {
    ...
    const { limit = 20, offset = 0, status, repoOwner, repoName } = request.query as any

    let whereConditions = [eq(jobs.installationId, parseInt(installationId, 10))]
  ...
  fastify.get('/installations/:installationId/jobs/:jobId', {
    preHandler: [authenticateInstallation],
    schema: {
      params: {
        type: 'object',
    ...
    const { installationId, jobId } = request.params as { installationId: string; jobId: string }
  ...
  fastify.post('/installations/:installationId/jobs/:jobId/cancel', {
    preHandler: [authenticateInstallation],
    schema: {
      params: {
        type: 'object',
  ...
  fastify.post('/installations/:installationId/jobs/:jobId/retry', {
    preHandler: [authenticateInstallation],
    schema: {
      params: {
        type: 'object',
  ...
  fastify.get('/installations/:installationId/stats', {
    preHandler: [authenticateInstallation],
    schema: {
      params: {
        type: 'object',
